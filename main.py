...
# All rights reserved by ShadowKing
...
🤖 **Name :** [Shadow Telegraph Bot](https://telegram.me/{})

👨‍💻 **Developer :** [Shadow King](https://t.me/ShadowKing9o)

🎥 **Movie Group :** [Movie Adda](https://t.me/+9Zhp_GdQVctiNjc1) 

👥 **Group :** [Shadow Arena](https://t.me/ShadowsArena)

🌐 **Source :** [👉 Click here](https://github.com/MasterShad0w/Shadow-Telegraph-Bot)
    ...
    if UPDATE_CHANNEL:
        try:
		  ...
		  reply_markup=InlineKeyboardMarkup(
            ...
            print(error)
            await update.reply_text(text="Something wrong. Contact <a href='https://t.me/ShadowKing9o'>Developer</a>.", disable_web_page_preview=True)
            return
    ...
    await text.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [  
                    InlineKeyboardButton(text="⚙ Join Updates Channel ⚙", url="https://telegram.me/ShadowsArena")
                ],
                [
                    InlineKeyboardButton('🎥Movie Addaa🎥', url='https://t.me/+9Zhp_GdQVctiNjc1')
                ]
